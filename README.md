...
1. Clone the repo:
   ```sh
   git clone https://github.com/abhinavanand20/react-job-portal.git
   ```
...
Abhinav Anand - [GitHub](https://github.com/abhinavanand20)

Project Link: [https://github.com/abhinavanand20/react-job-portal.git](https://github.com/abhinavanand20/react-job-portal.git)
